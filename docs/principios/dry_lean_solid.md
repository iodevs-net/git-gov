# Arquitectura git-gov v3.0: Mandamientos DRY, LEAN y SOLID
...
- **Mandamiento**: Ninguna lógica de Bulletproofs o TPM debe estar fuera de `git-gov-core::crypto`.
...
- **git-gov-witness (IDE)**: Única responsabilidad: Capturar el ritmo humano (CNS). No firma, no juzga.
- **git-gov-daemon**: Única responsabilidad: Transformar ritmo en Prueba Criptográfica (ZKP).
- **git-gov-cli**: Única responsabilidad: Certificar la prueba antes del commit.
...
---
*Actualizado para git-gov v2.1/v3.0 - 2026*