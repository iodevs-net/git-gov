...
echo -e "${BLUE}Git-Gov: Iniciando instalación formal...${NC}"
...
sudo cp target/release/git-gov-cli /usr/local/bin/git-gov
sudo cp target/release/git-gov-daemon /usr/local/bin/git-gov-daemon
...
# 5. Finalización
echo -e "--------------------------------------------------------"
echo -e "${GREEN}✅ Git-Gov instalado con éxito.${NC}"
echo -e "Comandos disponibles:"
echo -e "  - ${BLUE}git-gov-daemon${NC}: Inicia el centinela."
echo -e "  - ${BLUE}git-gov init${NC}: Activa la aduana en un repositorio."
echo -e ""
