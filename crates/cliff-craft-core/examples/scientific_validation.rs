//! Script de demostración científica para Cliff-Craft
//!
...
use cliff_craft_core::mouse_sentinel::{MouseSentinel, InputEvent};
use cliff_craft_core::stats::calculate_human_score;

fn main() {
    println!("--- Cliff-Craft Scientific Validation Suite ---\n");
