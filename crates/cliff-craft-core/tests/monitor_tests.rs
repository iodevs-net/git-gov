...
use cliff_craft_core::monitor::{GitMonitor, GitMonitorConfig, EditEvent, EditKind};
use cliff_craft_core::mouse_sentinel::InputEvent;
...
async fn test_monitor_initialization() {
    ...
    let _monitor = GitMonitor::new(
        ...
        input_rx, 
        file_rx, 
        PathBuf::from("/tmp/cliff-craft-test"),
        shutdown.clone()
