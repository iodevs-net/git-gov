...
pub const DEFAULT_SENSOR_SOCKET: &str = "/tmp/git-gov-sensor.sock";
...
mod tests {
    ...
    async fn test_sensor_socket_lifecycle() {
        let socket_path = "/tmp/git-gov-sensor-test.sock";
