...
use cliff_craft_core::protocol::{Request, Response};
use cliff_craft_core::mouse_sentinel::KinematicMetrics;
use cliff_craft_core::monitor::AttentionBattery;
use cliff_craft_core::stats::calculate_human_score;
use cliff_craft_core::focus_session::FocusTracker;
use cliff_craft_core::git::WitnessData;
use cliff_craft_core::crypto::zkp::HumanityProof;
    ...
    signing_key: Arc<cliff_craft_core::crypto::SigningKey>,
    min_entropy: f64,
}
...
impl IpcServer {
    pub fn new(
        ...
        events_captured: Arc<RwLock<usize>>,
        shutdown: CancellationToken,
        signing_key: cliff_craft_core::crypto::SigningKey,
        min_entropy: f64,
    ) -> Self {
                                ...
                                let response = match request_res {
                                    ...
                                    Ok(Request::GetTicket { cost }) => {
                                        ...
                                        if battery.consume(adjusted_cost) {
                                            ...
                                            let signature = cliff_craft_core::crypto::sign_data(&signing_key_lock, message.as_bytes()).ok();
                                            Response::Ticket {
                                                success: true,
                                                signature,
